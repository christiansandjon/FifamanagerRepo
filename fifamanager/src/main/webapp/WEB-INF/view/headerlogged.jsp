						...
						<div class="col">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button" style="margin: 5px 4px 4px 4px; border-radius: 4px;"><a
											href="/fifamanager/newchampionnat/">Creer championnat</a></div>
								</div>

								<div class="top_bar_login ml-auto" style="margin: 5px 4px 4px 4px; border-radius: 4px;">>
									<div class="login_button"><a href="/fifamanager">Se deconnecter </a></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<nav class="main_nav_contaner ml-auto">
								<ul class="main_nav">
									<li><a href="/fifamanager/student/calendrier">Classement</a></li>
									<li><a href="/fifamanager/student/mescours"></a>Matchs</li>
									<li><a href="/fifamanager/student/enseignant">Equipes</a></li>
									<li><a href="/fifamanager/student/compte">Stats</a></li>
								</ul>
