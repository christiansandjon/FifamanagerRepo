...
<div class="col-lg-4 course_col">
    <div class="course">
        <div class="course_image"><img src="${pageContext.request.contextPath}/resources/images/course_2.jpg" alt="">
        </div>
...
<div class="col-lg-4 course_col">
    <div class="course">
        <div class="course_image"><img src="${pageContext.request.contextPath}/resources/images/course_3.jpg" alt="">
        </div>
        <div class="course_body">
...
<div class="col-lg-4 course_col">
    <div class="course">
        <div class="course_image"><img src="${pageContext.request.contextPath}/resources/images/course_1.jpg" alt="">
        </div>
        <div class="course_body">
